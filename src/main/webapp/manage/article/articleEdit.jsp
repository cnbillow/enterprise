        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="10" class="tableBasic">
            ...
            <tr>
                <td colspan="2" style="text-align: center;">
                    <c:choose>
<%--Two requests in the controller are here. Here, the judgment is that the add button of the point comes over here, or the edit button of the point comes to this side --%>
                        <c:when test="${e.id!=0}">
<%-- The form specifies the path to manage/article, where the method is specified --%>
