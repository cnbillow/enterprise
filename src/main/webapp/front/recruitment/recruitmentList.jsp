...
<%--                get data directly from the cache manager--%>
                <c:forEach var="item" items="<%=SystemManage.getInstance().getRecruitments()%>">
                    <div class="recruitmentList">
                        <p><span style="background-color: #ff0000; font-family: 微软雅黑, microsoft yahei;
                        color: #ffffff; font-size: 16px;">${item.position}</span></p>
                        <p>工作性质：
