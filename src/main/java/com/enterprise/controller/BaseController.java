...
/**
 * 抽象控制类
 * //If you don't implement all the abstract methods, you must become an abstract class.
 * @author Cesiumai
 *
 * @param <E>
 */
...
// Other places put e in the model layer, use it here, get the corresponding service directly
...
// Understand that the use of modelAttribute, directly into the model layer, jsp can directly use e to use
		this.initPageSelect();
...
// Many places use @ModelAttribute("e"), which should be placed in the model layer, so let's use it.
